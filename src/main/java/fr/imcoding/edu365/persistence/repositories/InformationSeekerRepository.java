...
public interface InformationSeekerRepository extends JpaRepository<InformationSeeker, Long> {
  ...
  List<InformationSeeker> findBycurrentLevelSkillAreaCodeAndCurrentLevelSectionCode(String currentLevelCode, String currentLevelSectionCode);

  List<InformationSeeker> findBycurrentLevelSkillAreaCodeAndCurrentLevelSectionCodeAndIsEmailverifiedTrue(String currentLevelCode, String currentLevelSectionCode);
